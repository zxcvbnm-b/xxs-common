...
//        defaultCodeGenerator.relationCodeGenerator("perm_user_group", relationTableInfos);
     ...
     * @throws Exception
     */
    private void relationCodeGenerator(String mainTableName, String relationTableName, String relationColumnName, boolean one2One) throws Exception {
        //执行之前的拦截功能扩展
        GenerateFilterContext generateFilterContext = codeGenerateContext.getGenerateFilterContext();
        generateFilterContext.init(codeGenerateContext);
        List<Template> genTemplate = codeGenerateContext.getTemplates();
    ...
    //TODO 一对多 一对一关系测试
    private void buildRelation(TableInfo mainTable, String relationTableName, String relationColumn, boolean one2One) throws SQLException {
