...
public class LoadPropertyUtils {
    ...
    public static synchronized void loadPropertyFile(String... propertyFiles) {
        for (String fileName : propertyFiles) {
            try (InputStream fis = LoadPropertyUtils.class.getResourceAsStream(fileName);) {
                properties.load(fis);
    ...
    public static XxsProperties copy() {
        return new XxsProperties(properties);
    }
}
